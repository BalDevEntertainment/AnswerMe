...
import com.baldev.answerme.services.AnswerMeFCMService;
...
public class VolleyHelperImplementation implements PushNotificationsManager {
	...
	public static class DataJson extends JSONObject {
		...
		private static final String KEY_BODY = AnswerMeFCMService.KEY_BODY;
	...
	public static class HeaderJsonObjectRequest extends JsonObjectRequest {
		...
		public Map<String, String> getHeaders() throws AuthFailureError {
			...
			headers.put("Authorization", "key=AIzaSyDg3lcLGqW2Ga7Z3eaJkdUEucBvn--XfGM");
			return headers;
		}
	}
}
